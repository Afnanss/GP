...
List<DataModel> dataList = [
  DataModel("Saudi Arabia map ", "images/a.png", "This exhibit shows the geography of the Kingdom of Saudi Arabia and i ts surface features, including mountains, plateaus and seas, in addition to defining the thirteen administrative regions and the most prominent cultural and civilizational manifestations in each region. It also highlights the most important ministries in the Kingdom, such as education and health, and their achievements.","NearBy"),
